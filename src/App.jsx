...
const UI = {
  en:{ headline:"One Trillion", sub:"AI Prompts.", tagline:"The world's largest prompt archive — indexed, rated, and ready to deploy.", searchPH:"Search one trillion prompts…", searchBtn:"SEARCH", searching:"SEARCHING…", featured:"FEATURED FROM THE ARCHIVE", results:"RESULTS FOR", memberSince:"MEMBER SINCE", welcomeBack:"WELCOME BACK", unlimited:"UNLIMITED ACCESS", joinAcademy:"JOIN VICTORY HOUR ACADEMY", signOut:"SIGN OUT", createAcc:"CREATE FREE ACCOUNT →", signInBtn:"SIGN IN →", nameLabel:"FULL NAME", emailLabel:"EMAIL ADDRESS", passLabel:"PASSWORD", createTab:"CREATE ACCOUNT", loginTab:"SIGN IN", freeAccess:"Free access to one trillion prompts.", noLimits:"Create your free account. No credit card. No limits.", welcomeBack2:"Welcome back to the", archive:"archive.", alreadyHave:"Already have an account?", newHere:"New here?", hunger:"♥ 10% OF ALL PROCEEDS FIGHTS WORLD HUNGER", deeperTitle:"Go deeper with AI training", deeperSub:"built for builders.", deeperBody:"Courses, community, and tools inside Victory Hour Academy. Free to join — just like PromptVault.", joinFree:"JOIN FREE →", copyPrompt:"COPY PROMPT", copied:"✓ COPIED", retrieving:"RETRIEVING FROM THE ARCHIVE…", viewFull:"VIEW FULL PROMPT →", of:"OF", tagline2:"Clarity. Strategy. Action." },
